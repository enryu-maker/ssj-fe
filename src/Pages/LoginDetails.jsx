...
import { VerifyUserDetailsAsync, isUserDetailsCompleted, selectIsAuthenticated, selectLoggedInUser } from "../features/Auth/authSlice";
...
function LoginDetails({ setModal, number }) {
  ...
  const isUserDetailCompleted = useSelector(isUserDetailsCompleted);
  ...
  const handleSubmit = (e) => {
    ...
    console.log(token);
    dispatch(VerifyUserDetailsAsync(fullData));
    setModal(); 
  };
