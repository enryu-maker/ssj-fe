...
const AboutUs = () => {
  return (
    <div className='font-Raleway min-h-screen p-5 md:p-10'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
        <div className='text-left'>
          <h1 className='text-3xl md:text-4xl font-extrabold text-primary-color mb-5'>About Sai Shraddha Jewellers</h1>
        ...
        <div className="md:order-first relative mt-5 md:mt-0">
          <img src={Image} alt="Sai Shraddha Jewellers" className="rounded-lg shadow-lg mx-auto" style={{ maxWidth: '100%', height: 'auto' }} />
          <div className="gradient-animation absolute inset-0 rounded-lg"></div>
        </div>
      </div>
      <div className="flex justify-center mt-6">
        <div className="bg-gradient-to-r from-primary-color to-secondary-color rounded-full h-2 w-24 md:w-36 animate-pulse"></div>
      </div>
    </div>
  );
};
