        ...
        <div className="flex flex-col md:flex-row items-center justify-around font-Raleway px-5">
          <div className="flex flex-col gap-5 py-10 overflow-y-auto md:max-w-2xl md:w-full">
            {cart.cartItems.map((cartItem) => (
              <div key={cartItem.id} className="flex flex-col md:flex-row gap-5 items-start">
                <img
                  src={cartItem.image}
                  alt={cartItem.name}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <p>|</p>
                    <button onClick={() => handleMoveToWishlist(cartItem)} className="text-xs font-semibold flex gap-2 items-center">
          ...
          {/* Order Summary */}
          <div className="flex flex-col items-center text-justify justify-between gap-5 py-10 bg-light-bg-color md:w-1/4 w-full p-4 md:max-w-sm">
            <h1 className="text-2xl font-semibold text-primary-color">
              ORDER SUMMARY
            </h1>
