      ...
      <Swiper
        ...
        <SwiperSlide>
          <img
            ...
            alt=''
          />
          <div className='absolute font-Raleway left-10 right-10 md:top-44 top-24 '>
            <p className='mt-5 md:text-4xl text-3xl font-light md:w-96 text-left text-white'>
              We are selling happiness
            </p>
            <button className=' mt-5 md:flex  uppercase bg-transparent delay-100 transition-all duration-75 ease-linear hover:border-2 text-secondary-color font-semibold hover:text-primary-color py-2 px-4 border border-primary-color  rounded-full'>
              Explore More
            </button>
          </div>
        </SwiperSlide>
