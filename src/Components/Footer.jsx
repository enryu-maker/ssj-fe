      ...
      <div className="container mx-auto px-5 md:px-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div className="mt-10 sm:mt-20">
            <h1 className="text-xl mb-6 sm:mb-10 text-primary-color font-semibold">
              Useful Links
            </h1>
            <div className="flex flex-col gap-2 sm:gap-4">
              {UsefulLinks.map((item, index) => (
                <Link
                  to={item.link}
                  key={index}
                  className="text-lg md:text-xl hover:text-primary-color"
                >
                  {item.name}
                </Link>
              ))}
          ...
          <div className="mt-10 sm:mt-20">
            ...
            <div className="flex flex-col gap-2 sm:gap-4">
              <div className="flex items-center gap-2 md:gap-3 text-lg md:text-xl">
                ...
                <a
                  href="mailto:saishraddhajewellers@gmail.com"
          ...
          <div className="mt-10 sm:mt-20">
            ...
            <div className="flex flex-col gap-2 sm:gap-4">
              <a
                href="https://www.instagram.com/saishraddhajewellersofficial/"
                className="flex items-center gap-2 text-lg md:text-xl hover:text-primary-color"
              >
                <FaInstagram className="text-xl md:text-3xl" />
                Instagram
              </a>
              <a
                href="https://www.facebook.com/saishraddhajewellersofficial/"
                className="flex items-center gap-2 text-lg md:text-xl hover:text-primary-color"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UCkkAllN-8Xr3n4aRjBxpfIA"
                className="flex items-center gap-2 text-lg md:text-xl hover:text-primary-color"
              >
        ...
        <div className="mt-10 py-2 text-primary-color flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 text-sm">
            <Link
              ...
              className="hover:font-semibold transition-all ease-linear delay-75"
            >
              Terms & Conditions |
            </Link>
            <Link
